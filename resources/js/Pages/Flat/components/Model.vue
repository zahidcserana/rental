...
<!--                                                <DropdownList :label="'House'" :endpoint="'house-list'" :model="form.house_id" @rowId="setHouse" />-->
                                            ...
                                            <div class="col-sm-6">
                                                <DropdownList :label="'Customer'" :endpoint="'customer-list'" :model="form.customer_id" @rowId="setCustomer" />
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h5><b>Total: </b> <span class="float-right">{{ number2Decimal(totalRent) }}</span></h5>
                    </div>
...
import DropdownList from '@/Shared/Form/DropdownList.vue'
