                                ...
                                <div class="m-section__content">
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label><b>Month</b></label>: {{ formatDate(param.data.date) }}
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input v-model="form.status" class="form-check-input" type="radio" name="status" value="due" />
                                                        <label class="form-check-label" for=""> Due </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 invoice-table">
                                                ...
                                                <div v-for="(row,index) in param.data.invoice_items" :key="index" :class="[index%2==0? 'row':'odd-row row']">
                                                    ...
                                                    <div class="col-md-4">{{ row.amount }}</div>
                                                </div>
                                                <div class="row div-footer">
                                                    <div class="col-md-4">&nbsp;</div>
                                                    <div class="col-md-4">Subtotal</div>
                                                    <div class="col-md-4">{{ param.data.subtotal }}</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 summary-div-row">
                                                <div class="row summary-row">
                                                    ...
                                                    <div class="summary-div">
                                                        ...
                                                        <input min="0" type="number" class="text-div form-control" v-model="form.paid" @keyup="getTotal"/>
                                                    </div>
                                                    <div class="summary-div">
